...
%Merge requirements 3 and 5, or simply remove 3 would be better.
...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|p{12cm}|}
    ...
    \multicolumn{2}{|l|}{The visualizations should \ldots} \\ \hline
      ...
      F1-3 & make it possible to compare multiple days \\ \hline
      F1-4 & make it easy to identify hours of the day where activity can be added \\ \hline
      F1-5 & show the activity level compared to national or personal goals \\ \hline
      F1-6 & let the user identify patients that are active during the night \\ \hline
      F1-7 & let you compare two separate weeks to see the patients progress \\ \hline
      F1-8 & be printable in grayscale \\ \hline
  \end{tabular}
  \end{center}
