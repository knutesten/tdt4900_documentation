...
\begin{table}[!h]
  \begin{tabular}{|c|p{10cm}|}
    ...
    S1 & Analysing patients current activity level either individually or in cooperation with other physiotherapists. \\ \hline
    S2 & In consultation with the patient. \\ \hline
    S3 & In communication with other health care personnel. \\ \hline
