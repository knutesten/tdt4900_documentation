...
\begin{figure}[h!]
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{\footnotesize User having one third of his daily NikeFuel goal~\cite{fuelbandDcRain}.}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth]{ringfire.png}
    \caption{\footnotesize User beating his daily limit by 150\%, rewarding him with special effects on the ring~\cite{fuelbandTechSpce}.}
  \end{subfigure} 
  \caption{}
  \label{fig:tworings}
\end{figure}
