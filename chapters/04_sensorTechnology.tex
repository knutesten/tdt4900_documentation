...
activPAL differs from the other sensor presented in this chapter in that it is designed for use in research and not commercial use. The sensor has a longer battery life than Fitbit and Nike+, but does not include a practical way to be carried and has to be taped to the thigh. It is also much bigger than Fitbit and Nike+. 

activPAL is frequently used in research, several studies have been conducted which concludes that the sensor is viable for recording and classifying activity \cite{grant2006, ryan2006, grant2008, tsavourelou}. The sensor has also been used in multiple studies for obtaining and analysing activity patterns~\cite{grant2010, lord, ryan2010}.
