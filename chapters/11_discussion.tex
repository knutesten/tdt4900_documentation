...
Talking with the physiotherapists also gave us the ability to explore \gls{ux} requirements for the system, see table~\ref{tab:f2ReqUx}. Usability is important for any system, but especially one that should be used in medical settings. % I have no idea if this is correct.
...
% Should we add a section about this?
