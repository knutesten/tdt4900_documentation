...
Feedback from the first focus group was used to improve the visualizations, table~\ref{changeLog} shows a list of the changes made to the original system. U2, F2, T2 and T3 were discarded by the first focus group and was removed from the system for the second prototype. 
