...
This section provides and overview of how our chosen research methods relate to each other and how they to the research questions we have posed. Table ~\ref{tab:designPlan} gives a quick summary of our methods, their purpose and how they relate to our research questions. 
...
The order in the table reflects in what order they appear in the report and were conducted.
...
\begin{table}[h!]
  ...
  \begin{tabular}{|p{0.7cm}|p{2cm}|p{9cm}|}
    ...
    % REVIEW: Did we really not use these for anything?
...
% REVIEW: Is this true though? Does she have extensive knowledge about visualizing sensor data?
...
A questionnaire would be created after the first focus group and presented before the second. The purpose was to gain more background information on the participants and gain an understanding of their attitude towards technology and change in their working environment.
% REVIEW: Is new technology considered to be change in the environment? Isn't environment more like where they work?
...
% REVIEW: We have not mentioned the last interview anywhere.
