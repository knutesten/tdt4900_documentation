\chapter{Validity}
Addressing and reflecting upon the validity our research methods is vital in order to strengthen our findings and show that we are not unaware that no method or execution is without its flaws. This chapter starts off by reflecting the our research methods and finishes off by addressing their validity in accordance to possible threats presented in section~\ref{subsec:threatsValidity} 
