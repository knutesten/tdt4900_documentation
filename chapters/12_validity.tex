...
In the overall plan for our research (section~\ref{sec:overview}) we present an outline on how we planned to conduct our research. Table~\ref{tab:designPlan} shows correlation between research method and research questions. During the focus groups and interviews we made sure that the participants had understood the question, and encouraged them to repeat it or provide a response to confirm that this was the case. 

//Litt usikker på hva jeg skal skrive om construct validity og prototype. Forslag knut, HELP ME!
