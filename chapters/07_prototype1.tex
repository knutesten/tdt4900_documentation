\chapter{Prototype 1}
\label{ch:prototype1}
In this chapter we explain the role activPal plays in our prototype and explain the software frameworks and programming languages we use to build the prototype software.
