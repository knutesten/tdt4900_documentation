...
% Are you sure it is possible to display raw accelerometer data. I think that option is not available. 
...
% I would not say that activePAL is not important, I would rather say that the type of sensor is not important. Don't make it sound like we didn't consider other sensors. Just say that it came recomended from the hosiptal or something. 
activPAL is not vital part of our prototype, instead it was a sensor that was available to us and has been proven trustworthy in other research. Other sensor can be used as long as the data given as input to the visualizations has a certain structure.
