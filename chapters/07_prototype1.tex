...
Before the starting the implementation of the system we created a set of paper sketches of the visualizations that we planned to implement. These were our first ideas on the visualizations that would fulfil the initial requirements efficiently, while providing several alternative to choose from. Due to lack of time and some problems finding physiotherapists in the earlier stages of development we were not able to get any feedback on the paper sketches from the users. The paper sketches were therefore only reviewed by our supervisor before the actual implementation was started.
...
>>>>>>> ac69607bd4c8b467a62713b7530cd038a1940229
