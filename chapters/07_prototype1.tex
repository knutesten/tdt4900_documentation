...
%%We need some filler text here once the section is done.
\subsection{HTML5}
...
% This may not be very relevant. Siste biten er kanskje ikke det lenger ettersom vi lager det kun til pc skjermer.
...
%Siste setning skrevet i future tense, husker du advarte meg mot det så gjør det samme.
