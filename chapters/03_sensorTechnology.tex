...
% Maybe we should move this section so that is comes after the section about quantified self and personal informatics? Response: DONE
\section{Presentation of sensor data}
%BRAIN AIN'T WORKING TODAY! REWRITE IOR AT LEAST FIX IT PLX
...
% REVIEW: Look at the first sentence is it OK? RESPONSE: IT IS OK
