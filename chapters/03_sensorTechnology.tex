...
% REVIEW: Read this section, thought it was important to mention that self-improvement is the goal not just the collection of data. RESPONSE: Switched two sentences, OK!
...
% REVIEW: I think it is OK to mention it, we need the text don't we? RESPONSE: OK
...
% REVIEW: This section should probably be a bit larger. What do you think? REPONSE: I am not sure, feel like we say what we need to, how would you make it larger?
...
In this section we look at how commercial activity monitoring devices present their data. The products that will be discussed are Nike Fuelband, Fitbit Flex and activPAL. Both Nice Fuelband and Fitbit Flex are designed for the general public while activPAL is manly used in research project. Nice Fuelband and Fitbit Flex therefore has a much larger specter of different visualizations and feedback systems, as we shall see in this section.
