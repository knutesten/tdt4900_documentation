...
% What does this mean "splice their data much better" DEAN: FIXED
...
In 2011 \gls{qs} had their first conference \cite{bodyHackers}, here people shared data that they had collected about themselves with different types of devices. The goal is to use qualitative data to learn about and improve yourself. Members of \gls{qs} collect information about everything from sleep patterns and diets to mood and stress levels. 


%(Cut the next paragraph to shorten this section?) I am starting to vote we cut it, it has no real value unlike the extra sectin under PI. If you agree delete the comment below
...
%REVIEW: Previously in this section you make it sound like it's own community now you say that it is a label used to classify a set of tools? Dean: Rewrote section above
...
% REVIEW: Use glossary here for CHI. Dean: OK
