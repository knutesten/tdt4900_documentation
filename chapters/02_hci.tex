...
%Review: Blir det ikke Visulizations utilize bla bla bla" og ikke "creating visulizations" Må skrives om til By creating visulizations one can utilize bla bla bla?"
...
%Review: I am not sure how I feel about the section below, the content is not neccessarily bad, the presentation is just terrible though. Needs to be tables i think. Why do you go from a section to subsubsections instead? and why is Data Types empty?
