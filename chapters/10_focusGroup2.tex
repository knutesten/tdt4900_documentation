...
The focus group was conducted at St. Olav's Hospital, but we were unable to obtain the exact same room.  Much like the first session the participants were seated around a table facing a projector canvas. The visualizations were controlled by the assistant moderator.
...
After the questionnaire the scenarios created after the first focus group was presented to the participants to get their opinion. The participants were asked to provide additional scenarios if they felt that the existing ones did not cover all the possible uses of the technology presented.

The visualizations were presented one by one as in the fist focus group. The participants then gave feedback on the modifications made as well as the new features. When all the visualizations had been presented and discussed the participants were presented different colour choices. A laptop was used for this purpose as it was hard to differentiate the gradient colour on the projector. The participants were also shown printouts of grayscale versions of some of the visualizations.

The participants were then presented with the requirements created after the first focus group. After a brief introduction to software requirements, the participants were asked to go through the requirements and make comments on requirements they felt were missing or unclear. 

After the requirements had been reviewed the findings of the focus group was discussed to remove any ambiguity. The last part of the focus group was used for an unstructured interview with the physiotherapists about how physiotherapy is practice in Norway. 
