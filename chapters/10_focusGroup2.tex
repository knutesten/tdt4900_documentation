...
\section{Results}
This section contains the results of the second focus group. New revisions of the scenarios and the requirements are presented, and the participant's feedback and comments on the visualizations of the second prototype is covered in some detail. The two last sections contains a discussion about colour choices and printouts of the visualizations and a description of how physiotherapy is practices in Norway.
