...
The second focus group had several goals. The first was to verify the scenarios and requirements that were created after the first focus group. These requirements were then implemented into our second prototype which was presented to the participants so feedback could be received. Finally an interview was conducted with one of the participants so we could understand their daily routine at work. Much like the previous focus group chapter this one starts with introducing the participants and procedure before presenting the results at the end.
