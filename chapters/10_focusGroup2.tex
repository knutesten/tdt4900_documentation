...
%Hvorfor har du fjernet der hvor jeg nevner at vi tok opptak og den varte i 2 timer?
...
%Vet ikke du nevner det et et annet sted, du nevner at de ikke likte goal circles men ikke hvorfor. Det er ikk eat de ikke likte sirklene, men syntes det ble mye info på en gang når de kom i tilleg.
...
%What? ``Found it hard to T1'', found to do what, read, rape, see?
...
One requirement which all of the participants wished to clarify was F1-1. They were specific that it should not be national goals, but national recommendations, this was rectified in the new requirements. Two of the participants mentioned that an overview of the week was good, but receiving an summary of the daily activity was equally important. This was provided by the pie chart but was never explicitly stated as a requirement, F2-9 was added to reflect this.

Being able to include or exclude certain hours of the night was also discussed due it being brought up during several visualizations. There was disagreement on what counted as ``night'', and if a certain time interval should be set by the user or pre-set value should be used. Nevertheless F2-10 has been added. %Like ikke helt formuleringen på F-11, men vil få frem at det dataene ikke fjernes fra visalisasjonen direkte, men de blir aldri ``lest'', blir ikke grået ut eller noe. Som et alternativ kan vi inkludere at biten som er natt kommer som en anne farge. Altså egentlig en pie chart med 4 farger.

%Rename user requirements?
...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|p{12cm}|}
    ...
    \multicolumn{2}{|l|}{The visualizations should \ldots} \\ \hline
      ...
      F2-10 & should able to toggle if hours of the night should be included or excluded. \\ \hline
  \end{tabular}
  \end{center}
  \caption{Functional requirements from the second focus group}
\end{table}

When presented with the user experience they were initially a bit confused of what exactly these requirements entailed. Although after a brief explanation they had understood the purpose and requirements. F1-12 should be clarified to include not just the user, but other non medical partners as well, this is now reflected in F2-14. According to the participants some patients are simply not well enough cognitively to understand the visualizations no matter how simple they are. Therefore F1-13 has been changed accordingly (F2-15).
