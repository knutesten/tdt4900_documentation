...
\include{./chapters/2_hci}
\include{./chapters/3_sensorTechnology}
\include{./chapters/4_physicalTherapy}
\include{./chapters/5_researchDesign}
\include{./chapters/6_initialRequirements}
\include{./chapters/7_prototype1}
\include{./chapters/8_focusGroup1}
\include{./chapters/9_prototype2}
