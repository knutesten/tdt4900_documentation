...
\item[Hypothesis F2:] The ball chart makes it easier to identify sedentary intervals, while depicting the ratio between the activities in an efficient matter.

\item[Hypothesis F3:] The pie chart is the easiest out of the three to grasp, because it is the most common one.
...
\item[Hypothesis T2:] The continous timeline is useful for going through the patients day.

\item[Hypothesis T3:] Two 12 hour clocks are easier to interpret then a single 24 hour clock.

\item[Hypothesis W1:] The smiley week is a good and simple starting point when consulting with patients about their days
\end{description}
