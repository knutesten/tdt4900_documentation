...
\section{Prototype goal}
The prototype is to be used in a focus group, and therefore needs to be of adequate quality. The visualizations need to be implemented as close as possible to our sketches and behave as expected.


Hypothesis 1: The stick figures will make the symbolic box chart more intuitive than the pie chart, removing the need for legends.

Hypothesis 2: The ball chart makes it easier to identify sedentary intervals, while depicting the ratio between the activities in an efficient matter.

Hypothesis 3: The pie chart is the easiest out of the three to grasp, because it is the most common one.

Hypothesis 4: The blocked timeline makes it easier to identify hours of the day with high sedentary instead of the continuous timeline.

Hypothesis 5: The continous timeline is useful for going through the patients day.

Hypothesis 6: Two 12 hour clocks are easier to interpret then a single 24 hour clock.

Hypothesis 7: The smiley week is a good and simple starting point when consulting with patients about their days

Hypothesis 8: 

\section{Prototype implementation}
Skal vi skrive om endelig implementasjon av prototypen her?
