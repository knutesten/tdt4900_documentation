...
Our initial approaches were very scientific, and such we were advised to try more symbolic and metaphorical approaches. Using stick figures instead of colours to represent the various activities was one of the results, and a sketch can be seen below. (Figure \ref{fig:symbolicPie}). The size of each stick figure would reflect time spent in each activity, i.e. a large walking figure would represent a high amount of hours walking. %SKAL VI HA TELL HE ELLER IKKE, SI NOE OM HVORFOR/HVORFOR IKKE
